...
export declare const PARALLEL = "parallel";
export declare const SEQUENCE = "sequence";
export declare const STAGGER = "stagger";
export declare type AnimatorFlowValue = typeof ENTERING | typeof ENTERED | typeof EXITING | typeof EXITED;
 ...
 */
export declare type AnimatorSettingsDuration = Partial<AnimatorDuration>;
/**
 ...
 */
export declare type AnimatorSettingsManagerCustom = (status: AnimatorSettingsManagerStatus) => AnimatorChildActivations;
/**
 * The available `<Animator />` children flow transition managers.
 */
export declare type AnimatorSettingsManager = typeof PARALLEL | typeof SEQUENCE | typeof STAGGER | AnimatorSettingsManagerCustom;
/**
 * The implemented animator manager.
 */
export declare type AnimatorManager = AnimatorSettingsManager;
/**
 ...
 */
export declare type AnimatorSettingsOnAnimate = (animator: AnimatorRef, ...refs: any[]) => void;
/**
 ...
 */
export declare type AnimatorSettingsOnTransition = (flow: AnimatorFlow) => void;
/**
