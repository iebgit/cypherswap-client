...
const CommentSection = ({ newComments, post }) => {
    ...
    >
      <div className={classes.commentsOuterContainer}>
        ...
        <div style={{ marginTop: "5%", marginRight: "5px", minWidth: "25%" }}>
          ...
          <br />
          <Button FrameComponent={FrameBox} palette="secondary" style={{ marginTop: '10px' }} fullWidth disabled={!comment.length} color="primary" variant="contained" onClick={() => setComment('')}>
            Clear
          </Button>
