                ...
                <div className="col-span-1 flex">
                  {!show ? (
                    <svg
                      ...
                      strokeWidth={2}
                      stroke="#ffa76c"
                      className={`w-6 h-6 m-2 ${isDisabled || !isShowable ? "hidden" : `cursor-pointer`
                        }`}
                      onClick={async () => {
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`w-6 h-6 m-2 ${isDisabled ? "" : "cursor-pointer"
                        }`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
              ...
              <>
                {!(typeof window.ethereum === "undefined") &&
                  ...
                  <div className={`grid-cols-6 gap-4 h-5 mb-2 pb-1`}>
                    <center><LoadingBars animator={true} size={0.5} speed={5} /></center>
                  </div>
                ) : (
                  <></>
                )}
                ...
                <div className="flex flex-nowrap justify-between">
                  ...
                  <div className="flex flex-nowrap mr-36">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className={`h-5 w-5 ${isDisabled ? "cursor-default" : "cursor-pointer"
                        } m-2 transition-transform duration-200 ${isRotated ? "rotate-180" : "rotate-0"
                        }`}
                      onClick={() => {
                        if (!isDisabled) {
